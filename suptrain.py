...
dls = db.dataloaders(source=newdf, bs=96, num_workers=8)

# model=xresnet18(c_in=10, n_out=19)
model=timm.create_model('xcit_small_12_p8_224',num_classes=19, in_chans=10)
...
with learn.distrib_ctx(): 
    learn.fit_flat_cos(200, 1e-3,cbs=[CSVLogger(fname='supxcit.csv'),SaveModelCallback(monitor='accuracy_multi',fname='supxcit')])